...
class Fav extends Component {
    ...
    render() {
        ...
        let genreArr={ 28: "Action", 12: "Adventure", 16: "Animation", 35: "Comedy", 80: "Crime", 99: "Documentary", 18: "Drama", 10751: "Family", 14: "Fantasy", 36: "History", 27: "Horror", 10402: "Music", 9648: "Mystery", 10749: "Romance", 878: "Science Fiction", 10770: "TV Movie", 53: "Thriller", 10752: "War", 37: "Western"}
        let tempArr = [];
        tempArr.push("All genres")
        moviesArr.map((movieObj)=>{
            if(!tempArr.includes(genreArr[movieObj.genre_ids[0]])){
                tempArr.push(genreArr[movieObj.genre_ids[0]])
            }
        })
                            ...
                            <tbody>
                                {
                                    moviesArr.map((movieEle) => (
                                        <tr>
                                            ...
                                            <td>{genreArr[movieEle.genre_ids[0]]}</td>
